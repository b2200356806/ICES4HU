...
public class AppController {
    ...
    public String viewInstAccCreate() {return "admin/createInstAcc";}

    @GetMapping("/admin/manageAccount")
    public String viewAcc() {return "admin/manageAccount";}

    @GetMapping("/admin/regRequest")
    public String viewReg() {return "admin/regRequest";}
    ...
    public String viewStuAcc() {return "student/manageAccount";}

    @GetMapping("/student/evaluate")
    public String viewStuEval() {return "student/evaluate";}

    @GetMapping("/department_manager/assignInst")
    public String viewAssign() {return "department_manager/assignInst";}

    @GetMapping("/department_manager/createSurvey")
    public String viewSurvey() {return "department_manager/createSurvey";}

    @GetMapping("/department_manager/homePage")
    public String viewDMHome() {return "department_manager/homePage";}

    @GetMapping("/department_manager/manageAccount")
    public String viewDMAcc() {return "department_manager/manageAccount";}

    @GetMapping("/department_manager/viewResult")
    public String viewResult() {return "department_manager/viewResult";}

    @GetMapping("/department_manager/createDefault")
    public String viewDefault() {return "department_manager/createDefault";}

    @GetMapping("/instructor/createSurvey")
    public String viewInsSurvey() {return "instructor/createSurvey";}

    @GetMapping("/instructor/viewResult")
    public String viewInsResult() {return "instructor/viewResult";}

    @GetMapping("/instructor/homePage")
    public String viewInsHome() {return "instructor/homePage";}
