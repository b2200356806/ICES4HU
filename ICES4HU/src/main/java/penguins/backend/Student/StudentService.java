...
public class StudentService {
    ...
    public Student getStudentById(long userId) throws UserNotFoundException {
        return studentRepository.findByUserId(userId).orElseThrow(() -> new UserNotFoundException("Student not found. User Id: " + userId));
    }
    ...
    public List<Course> enroll(long userId, String courseCode)
        ...
        if (!Semester.isAddOrDropStarted())
            throw new AddOrDropFinishedException("Add/Drop is finished or not started yet");
